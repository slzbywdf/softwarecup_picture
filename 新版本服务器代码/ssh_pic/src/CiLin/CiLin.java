...
public class CiLin {
	...
	public static void initCiLin(){
		...
		String path="D://pic_configure/";
		try {
			//初始化<关键词， 编号set>哈希
			inFile = new BufferedReader(new InputStreamReader(new FileInputStream(path+"cilin/keyWord_Identifier_HashMap.txt"), "utf-8"));// 读取文本
			...
			//初始化<第一层编号，高度>哈希
			inFile.close();
			inFile = new BufferedReader(new InputStreamReader(new FileInputStream(path+"cilin/first_KeyWord_Depth_HashMap.txt"), "utf-8"));// 读取文本
			while ((str = inFile.readLine()) != null){
				strs = str.split(" ");
			...
			//初始化<前二层编号，高度>哈希
			inFile.close();
			inFile = new BufferedReader(new InputStreamReader(new FileInputStream(path+"cilin/second_KeyWord_Depth_HashMap.txt"), "utf-8"));// 读取文本
			while ((str = inFile.readLine()) != null){
				strs = str.split(" ");
			...
			//初始化<前三层编号，高度>哈希
			inFile.close();
			inFile = new BufferedReader(new InputStreamReader(new FileInputStream(path+"cilin/third_KeyWord_Depth_HashMap.txt"), "utf-8"));// 读取文本
			while ((str = inFile.readLine()) != null){
				strs = str.split(" ");
			...
			//初始化<前四层编号，高度>哈希
			inFile.close();
			inFile = new BufferedReader(new InputStreamReader(new FileInputStream(path+"cilin/fourth_KeyWord_Depth_HashMap.txt"), "utf-8"));// 读取文本
			while ((str = inFile.readLine()) != null){
				strs = str.split(" ");
